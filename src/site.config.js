...
export const site = {
  ...
  url: "https://Jiaxichen1.github.io",
  ...
  description:
    "Jiaxi Chen is an undergraduate student in Data Science and Big Data " +
    "Technology at Shantou University, working on hypergraph learning, " +
    "evidence fusion, and biomedical machine learning.",

  // Shorter line for link previews (WeChat, X, LinkedIn, Slack).
  socialDescription:
    "Undergraduate researcher at Shantou University working on hypergraph " +
    "learning, evidence fusion, and biomedical machine learning.",
